...
$sql="INSERT INTO  tblblooddonars(FullName,MobileNumber,EmailId,Age,Gender,BloodGroup,State,District,Message,status) VALUES(:fullname,:mobile,:email,:age,:gender,:blodgroup,:state,:district,:message,:status)";
...
<?php include('includes/header.php');?>
    ...
    <div class="container">
       ...
       <br><br> <h1 class="mt-4 mb-3">Become a <small>Donor</small></h1>
...
<div><input type="text" name="mobileno" onKeyPress="return isNumberKey(event)"  maxlength="10" class="form-control" required></div>
</div>
<div class="col-lg-4 mb-4">
