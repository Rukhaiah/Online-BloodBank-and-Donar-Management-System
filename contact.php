                ...
                <form name="sentMessage"  method="post">
                    ...
                    <div class="control-group form-group">
                        <div class="controls">
                            ...
                            <input type="tel" onKeyPress="return isNumberKey(event)"  maxlength="10" class="form-control" id="phone" name="contactno"  required data-validation-required-message="Please enter your phone number.">
                        </div>
                    </div>
                    <div class="control-group form-group">
                        <div class="controls">
